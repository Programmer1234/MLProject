...
e = svm_k_fold_validation(train_samples, train_labels, K);
success_rate = 1 - e;

end

function [e] = svm_k_fold_validation(data, labels, k)
...
for i = 1:k
    ...
    model = svmtrain(train_labels, train_set, svm_options);
    predicted_labels = svmpredict(test_labels, test_set, model);
